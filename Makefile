#############################################################################
# Makefile for building: socket
# Generated by qmake (3.1) (Qt 5.9.7)
# Project:  socket.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile socket.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DQT_DEPRECATED_WARNINGS -DQT_QML_DEBUG -DQT_SQL_LIB -DQT_CORE_LIB
CFLAGS        = -pipe -g -Wall -W -D_REENTRANT -fPIC $(DEFINES)
CXXFLAGS      = -pipe -g -std=gnu++11 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -Iwebsockets/include -isystem /usr/include/qt5 -isystem /usr/include/qt5/QtSql -isystem /usr/include/qt5/QtCore -I. -I/usr/lib64/qt5/mkspecs/linux-g++
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = socket1.0.0
DISTDIR = /home/usuario/Baixades/Entrega4Marzo/25FEB/baskorg/.tmp/socket1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -pthread -lz -lssl -lcrypto -L/home/usuario/Baixades/Entrega4Marzo/25FEB/baskorg/websockets/lib/ -lixwebsocket -lQt5Sql -L/usr/lib64 -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = 
...
Makefile: socket.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile socket.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents json.hpp jugador.h club.h usuari.h app.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp jugador.cpp club.cpp usuari.cpp app.cpp $(DISTDIR)/
	$(COPY_FILE) --parents my_app_ca_ES.ts my_app_es_ES.ts my_app_en_US.ts $(DISTDIR)/
...
main.o: main.cpp app.h \
		...
		club.h \
		json.hpp \
		websockets/include/ixwebsocket/IXWebSocketServer.h \
		websockets/include/ixwebsocket/IXSocketServer.h \
		websockets/include/ixwebsocket/IXConnectionState.h \
		websockets/include/ixwebsocket/IXSocketTLSOptions.h \
		websockets/include/ixwebsocket/IXWebSocket.h \
		websockets/include/ixwebsocket/IXProgressCallback.h \
		websockets/include/ixwebsocket/IXWebSocketCloseConstants.h \
		websockets/include/ixwebsocket/IXWebSocketErrorInfo.h \
		websockets/include/ixwebsocket/IXWebSocketHttpHeaders.h \
		websockets/include/ixwebsocket/IXCancellationRequest.h \
		websockets/include/ixwebsocket/IXWebSocketMessage.h \
		websockets/include/ixwebsocket/IXWebSocketCloseInfo.h \
		websockets/include/ixwebsocket/IXWebSocketMessageType.h \
		websockets/include/ixwebsocket/IXWebSocketOpenInfo.h \
		websockets/include/ixwebsocket/IXWebSocketPerMessageDeflateOptions.h \
		websockets/include/ixwebsocket/IXWebSocketSendInfo.h \
		websockets/include/ixwebsocket/IXWebSocketTransport.h \
		websockets/include/ixwebsocket/IXWebSocketHandshake.h \
		websockets/include/ixwebsocket/IXSocket.h \
		websockets/include/ixwebsocket/IXWebSocketInitResult.h \
		websockets/include/ixwebsocket/IXWebSocketPerMessageDeflate.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

jugador.o: jugador.cpp jugador.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o jugador.o jugador.cpp

club.o: club.cpp club.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o club.o club.cpp

usuari.o: usuari.cpp usuari.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o usuari.o usuari.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/socket/bin || mkdir -p $(INSTALL_ROOT)/opt/socket/bin
	-$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/socket/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/socket/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/socket/bin/ 
