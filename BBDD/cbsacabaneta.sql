...
INSERT INTO `clubs` (`id`, `nom`, `codi`, `propietari`, `color`) VALUES
(1, 'Bàsquet Sa Cabaneta', 'cab12345', 5, '8B0000'),
(3, 'Joventut Mariana', '89704a40', 5, '5682fc'),
(11, 'prova', '691884f4', 9, 'ac4e4e');
...
(241, '0', 'Prova', 'Familar', NULL, '12321321D', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(244, '0', 'Joventut Mariana', 'No soci', NULL, '12121212J', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3),
(245, '0', 'Tejami', 'Familar', NULL, '43434343U', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1),
(247, '0', 'Prova', 'Individual', NULL, 'Prova', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 11);
...
(9, 'prova', '5a2adef6-5c6a-11ea-9834-080027e47246', '5a5fpDpX00RPs');
...
--
ALTER TABLE `jugadors`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=248;
